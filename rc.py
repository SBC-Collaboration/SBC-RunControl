...
class MainWindow(QMainWindow):
    ...
    def set_up_workers(self):
        ...
        for cam in ["cam1", "cam2", "cam3"]:
            ...
            vars[f"{cam}_worker"].error.connect(self.guardian_worker.error_handler)
        ...
        for amp in ["amp1", "amp2", "amp3"]:
            ...
            vars[f"{amp}_worker"].error.connect(self.guardian_worker.error_handler)
        ...
        for ino in ["trigger", "clock", "position"]:
            ...
            vars[f"arduino_{ino}_worker"].error.connect(self.guardian_worker.error_handler)
