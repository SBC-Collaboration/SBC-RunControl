...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.run_live_time_edit, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.event_num_edit, 7, 0, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.event_time_label.sizePolicy().hasHeightForWidth())
        self.event_time_label.setSizePolicy(sizePolicy1)
        self.event_time_label.setLineWidth(1)
        self.event_time_label.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.event_time_label, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.event_time_edit, 9, 0, 1, 1)
...
"QPushButton:disabled {color: rgb(120, 120, 120);}")
        ...
        self.gridLayout.addWidget(self.run_state_label, 3, 0, 1, 1)

        self.run_live_time_label = QLabel(self.centralwidget)
        self.run_live_time_label.setObjectName(u"run_live_time_label")
        sizePolicy1.setHeightForWidth(self.run_live_time_label.sizePolicy().hasHeightForWidth())
        self.run_live_time_label.setSizePolicy(sizePolicy1)
        self.run_live_time_label.setLineWidth(1)
        self.run_live_time_label.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.run_live_time_label, 10, 0, 1, 1)

        self.event_num_label = QLabel(self.centralwidget)
        self.event_num_label.setObjectName(u"event_num_label")
        sizePolicy1.setHeightForWidth(self.event_num_label.sizePolicy().hasHeightForWidth())
        self.event_num_label.setSizePolicy(sizePolicy1)
        self.event_num_label.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.event_num_label, 6, 0, 1, 1)
...
"QPushButton:disabled {color: rgb(120, 120, 120);}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 404, 354))
...
"background-color: rgb(150, 150, 150);")
        ...
        sizePolicy2.setHeightForWidth(self.next_imag_but.sizePolicy().hasHeightForWidth())
        self.next_imag_but.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.tabs_widget, 0, 1, 12, 1)
        ...
        self.gridLayout.addWidget(self.run_edit, 5, 0, 1, 1)

        self.run_label = QLabel(self.centralwidget)
        self.run_label.setObjectName(u"run_label")
        sizePolicy1.setHeightForWidth(self.run_label.sizePolicy().hasHeightForWidth())
        self.run_label.setSizePolicy(sizePolicy1)
        self.run_label.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.run_label, 4, 0, 1, 1)

        self.sw_trig_but = QPushButton(self.centralwidget)
        self.sw_trig_but.setObjectName(u"sw_trig_but")
        self.sw_trig_but.setEnabled(True)
        sizePolicy2.setHeightForWidth(self.sw_trig_but.sizePolicy().hasHeightForWidth())
        self.sw_trig_but.setSizePolicy(sizePolicy2)
        self.sw_trig_but.setMinimumSize(QSize(0, 50))
        self.sw_trig_but.setFont(font)
        self.sw_trig_but.setCursor(QCursor(Qt.PointingHandCursor))
        self.sw_trig_but.setStyleSheet(u"QPushButton:enabled {color: rgb(0, 30, 100);}\n"
"QPushButton:disabled {color: rgb(120, 120, 120);}")
        self.sw_trig_but.setCheckable(False)

        self.gridLayout.addWidget(self.sw_trig_but, 2, 0, 1, 1)
        ...
        self.sw_trig_but.clicked.connect(MainWindow.sw_trigger)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sw_trig_but.setText(QCoreApplication.translate("MainWindow", u"SW Trigger", None))
