...
# export SLACK_WEBHOOK_URL = "https://hooks.slack.com/services/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"
...
error_dict = {
    "0000": "Success - Run control exited successfully.",
    "0001": "Run Control - Another instance of RC is running. Program exited.",
...
def error_handling(error_code):
    for key in error_dict:
        if error_code == key:
            ...
            """
            If you want the invalid error code to be printed to Slack
            slack_message = f"Invalid error code"
            requests.post(slack_url, json={"text": slack_message})
            """
            break
